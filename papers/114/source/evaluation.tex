...
%---------------------------------------
Below is a summary of the most recent survey results, conducted during spring 2025 using the Interactive Game project. The second column represents the percentage of students who agreed or strongly agreed. Overall, student responses were positive, as can be seen in Table 1. Similar results were reported in prior years~\cite{neller2008throw}. 
%---------------------------------------
