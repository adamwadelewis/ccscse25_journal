...
Recent educational developments have produced courses specifically targeting deep learning \cite{ng2018deep} and natural language processing \cite{jurafsky2000speech}. Becker et al. \cite{becker2023programming} describe the integration of transformer-based AI code generation tools into computing education, while Holland-Minkley et al. \cite{holland2023computer} examine challenges associated with teaching rapidly evolving AI technologies in liberal arts contexts. However, comprehensive approaches that effectively integrate traditional ML foundations with modern LLM applications remain underrepresented in the educational literature.
